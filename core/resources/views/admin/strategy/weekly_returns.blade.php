                ...
                <div class="card-body">
                    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
                        <div>
                            ...
                            <p class="text-muted mb-0">@lang('Track weekly performance for charts. Select a year (2022 to current), enter rates, and approve each week after it ends. Approved data appears on the Strategy Performance page; the dashboard shows the current year only.')</p>
                        </div>
                                        ...
                                        <div class="col-md-4 col-sm-6">
                                            <div class="border rounded p-3 h-100">
                                                ...
                                                <div class="input-group input-group-sm mb-2">
                                                    <input type="number" step="0.0001" min="-100" max="100" class="form-control" name="returns[{{ $fieldKey }}]" form="weeklyReturnsForm" value="{{ old('returns.'.$fieldKey, optional($record)->return_percent) }}" @disabled($isApproved || $isFuture)>
