...
<div class="crm-login">
    <div class="crm-login__panel">
        ...
        <form method="post" action="{{ route($routeName) }}" class="crm-login__form">
            @csrf
            <label>
                <span>Email</span>
                <input type="email" name="email" value="{{ old('email') }}" required autofocus placeholder="name@crownmaire.com">
            </label>
            <label>
                <span>Password</span>
        ...
        <p class="crm-login__note">Authorized personnel only. All access is audited.</p>
    </div>
</div>
@endsection
