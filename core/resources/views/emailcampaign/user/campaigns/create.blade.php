...
<section class="crm-card">
    <p class="ec-hint">Choose an admin template, then customize subject and body for this campaign only. You cannot create new master templates.</p>
    <form method="post" action="{{ route('ec.user.campaigns.store') }}" class="crm-form crm-form--stack" id="ec-campaign-create">
        @csrf
