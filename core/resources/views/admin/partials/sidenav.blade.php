    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                    ...
                    <div class="sidebar-submenu {{ menuActive(['admin.time.index*', 'admin.plan.index*', 'admin.strategy.*'], 2) }} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.strategy.payouts*') }}">
                                <a href="{{ route('admin.strategy.payouts') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Strategy Payout Approvals')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.strategy.reports*') }}">
                    <a href="{{ route('admin.strategy.reports.index') }}" class="nav-link ">
                        <i class="menu-icon las la-file-pdf"></i>
                        <span class="menu-title">@lang('Strategy Reports')</span>
                    </a>
                </li>
