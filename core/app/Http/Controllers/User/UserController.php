...
class UserController extends Controller
{
    public function home()
    {
        ...
        $data['chartData']        = StrategyPayoutService::userReturnAnalyticsChart($user);
        $data['strategyCharts']   = StrategyPayoutService::userStrategyChartsForDashboard((int) date('Y'));
    ...
    {
        $pageTitle      = 'Strategy Performance';
        ...
        return view($this->activeTemplate . 'user.strategy_performance', compact(
            'pageTitle',
            'plans',
            'selectedPlan',
            'yearSections'
