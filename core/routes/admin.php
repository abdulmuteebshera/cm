...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('StrategyReportController')->name('strategy.reports.')->prefix('strategy-reports')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::post('/', 'store')->name('store');
        Route::post('delete/{id}', 'destroy')->name('delete');
    });

    Route::controller('StrategyController')->name('strategy.')->prefix('strategy')->group(function () {
        ...
        Route::post('{planId}/weekly-returns', 'saveWeeklyReturns')->name('weekly.returns.save');
        Route::post('weekly-return/{id}/approve', 'approveWeeklyReturn')->name('weekly.approve');
        Route::post('weekly-return/{id}/reject', 'rejectWeeklyReturn')->name('weekly.reject');
        Route::get('{planId}/monthly-returns', 'monthlyReturns')->name('monthly.returns');
        Route::post('{planId}/monthly-returns', 'saveMonthlyReturns')->name('monthly.returns.save');
        Route::post('monthly-return/{id}/approve', 'approveMonthlyReturn')->name('monthly.approve');
