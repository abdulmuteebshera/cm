...
/** Absolute filesystem path for portal assets (stored beside /core, not in /core/public). */
function assetFilesystemPath(string $relativePath = ''): string
{
    $root = base_path('../');
    ...
    return $root . ltrim(str_replace(['/', '\\'], DIRECTORY_SEPARATOR, $relativePath), DIRECTORY_SEPARATOR);
}
